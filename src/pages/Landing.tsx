          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            <div className="col-span-2">
              ...
              <div className="flex items-center gap-4 mt-6">
                ...
                <a href="https://www.linkedin.com/company/reley-fast-property-network/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-muted/50 flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-muted transition-colors">
