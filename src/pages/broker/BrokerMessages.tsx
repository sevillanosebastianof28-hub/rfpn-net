// Broker Messages - uses the shared Messages component with broker context
...
export default function BrokerMessages() {
  ...
  useEffect(() => {
    ...
    const channel = supabase.channel(`broker-messages-${selectedThread}`)
  ...
  return (
    <div className="animate-fade-in">
      <PageHeader title="Messages" description="Communicate with developers and admin team"
